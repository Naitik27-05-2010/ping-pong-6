...
function preload(){
  p1_missed = loadSound("missed.wav");
  p1_paddel_touch = loadSound("ball_touch_paddel.wav");
}
  ...
  if(results.length > 0)
{
  ...
  score_right_Wrist = console.log("right_WristX = " + right_WristX + "right_WristY = " + right_WristY);
}
}
